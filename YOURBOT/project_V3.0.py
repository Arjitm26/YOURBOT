...
open_support_button = customtkinter.CTkButton(home, text=" <?> ", command=open_file2,corner_radius=0,width = 50)
open_support_button.place(x = 30,y = 421)
...
#method to open create bot window
def create_bot():
    cmd = 'python Bot.py'
    subprocess.Popen(cmd, shell = True)

help_button = customtkinter.CTkButton(home,text = "Create Bot",corner_radius=0,command = create_bot,fg_color = 'Black')
...
# Create the text Correction tab
